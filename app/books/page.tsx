...
import { BOOKS_THEMES, MOOD_THEMES, resolveItemUrl } from '@/lib/media/curation';
...
function cards(items: { title: string; creator?: string; cover?: string | null; url: string }[], n = 14) {
  return items
    .slice(0, n)
    .map((i) => ({ title: i.title, subtitle: i.creator || '', cover: i.cover, href: resolveItemUrl(i, '/books/') }));
}
