...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes = ['', '/music/', '/games/', '/film/', '/tv/', '/tools/', '/tools/playlist/', '/tools/tastetwin/', '/tools/wheretogo/', '/articles/', '/data/', '/about/'];
  ...
  const all = [...staticRoutes, ...musicThemeRoutes, ...gameThemeRoutes, ...filmThemeRoutes, ...tvThemeRoutes, ...articleRoutes];
  return all.map((p) => ({
    url: `${base}${p}`,
