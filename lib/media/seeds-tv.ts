...
export const TV_THEMES: CurationTheme[] = [
  ...
  editorialNotes: {
    'The Sopranos': 'We open with The Sopranos because it states the list\'s argument before anything else needs to. The reason it leads: The Sopranos is the easiest yes on the list, the door that opens the rest. No gate to clear, which is the point: it lets you in before the harder picks do. Beside its neighbors it reads as the cleanest statement of the whole series; bingeing it in order and the arc holds.',
    'Breaking Bad': 'Breaking Bad arrives early on purpose, widening the mood before the heavier titles in this list ask for more. In context, Breaking Bad is the accessible face of the idea, the handhold before the deeper cuts. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the connective tissue of the whole series; bingeing it in order and the arc holds.',
    'Mad Men': 'Mad Men arrives early on purpose, widening the mood before the heavier titles in this list ask for more. In context, Mad Men is the accessible face of the idea, the handhold before the deeper cuts. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the connective tissue of the whole series; bingeing it in order and the arc holds.',
    'The Wire': 'The Wire arrives early on purpose, widening the mood before the heavier titles in this list ask for more. In context, The Wire is the accessible face of the idea, the handhold before the deeper cuts. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the connective tissue of the whole series; bingeing it in order and the arc holds.',
    'House of Cards': 'House of Cards is the pivot of the set — close enough to trust, far enough to justify its place. House of Cards does the quiet work — it bridges the obvious pick and the one that demands more of you. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the connective tissue of the whole series; bingeing it in order and the arc holds.',
    'Dexter': 'Dexter is the pivot of the set — close enough to trust, far enough to justify its place. Dexter does the quiet work — it bridges the obvious pick and the one that demands more of you. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the connective tissue of the whole series; bingeing it in order and the arc holds.',
    'Ozark': 'Ozark is the pivot of the set — close enough to trust, far enough to justify its place. Ozark does the quiet work — it bridges the obvious pick and the one that demands more of you. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the connective tissue of the whole series; bingeing it in order and the arc holds.',
    'Succession': 'Succession is where we land — the pick for when "the antihero era: television grew up" has been felt, not just described. Why it closes: Succession is the longest echo — the one that stays after the list ends. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the quiet afterimage of the whole series; bingeing it in order and the arc holds.',
  }},
  {
