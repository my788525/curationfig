...
export const FILM_THEMES: CurationTheme[] = [
  ...
  editorialNotes: {
    'Tokyo Story': 'Ozu\'s 1953 master cuts almost nothing in time yet everything in feeling — still frames and empty rooms are the grammar of patience the rest of this list only scales up. The easiest yes here because it teaches the mode before demanding it.',
    'Stalker': 'Tarkovsky\'s three-hour walk into the Zone is the list\'s most generous on-ramp: the long take feels like breathing, not endurance. If slow cinema is going to win you, it wins you here.',
    'Werckmeister Harmonies': 'Béla Tarr\'s single-take sequences — the famous circular crane shot runs minutes — make waiting the spectacle. It belongs because it asks the most and explains the least: the purest version of the thesis.',
    'Colossal Youth': 'Pedro Costa\'s portrait of Cape Verdean immigrants in Fontainhas lingers on faces and silences until time itself becomes the subject. The list\'s most politically charged patience — slowness as witness, not style.',
    'Goodbye to Language': 'Godard\'s 3D essay refuses narrative entirely; images and aphasia are the point. It\'s the pivot because it trusts the viewer to sit inside contradiction rather than resolve it.',
    'The Tree of Life': 'Malick spans a childhood and the cosmos in unhurried memory; the non-linear drift is the argument. It bridges the accessible picks and the ones that withhold everything.',
    'Once Upon a Time in Anatolia': 'Ceylan\'s night-time search for a buried body unfolds in real-time lethargy; the reveal, when it comes, barely matters. The patience is the plot — exactly what this list was built to gather.',
    'Sátántangó': 'Tarr\'s seven-hour adaptation is the genre\'s outer limit: a single rain-soaked day stretched past endurance into transcendence. It closes the list because nothing after it can ask more of you.',
  }},
  {
