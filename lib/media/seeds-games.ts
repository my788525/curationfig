...
export const GAME_THEMES: CurationTheme[] = [
  ...
  editorialNotes: {
    'DARK SOULS III': 'We open with DARK SOULS III because it states the list\'s argument before anything else needs to. The reason it leads: DARK SOULS III is the easiest yes on the list, the door that opens the rest. No gate to clear, which is the point: it lets you in before the harder picks do. Beside its neighbors it reads as the cleanest statement of the whole game; playing it in order and the arc holds.',
    'Elden Ring': 'Elden Ring arrives early on purpose, widening the mood before the heavier titles in this list ask for more. In context, Elden Ring is the accessible face of the idea, the handhold before the deeper cuts. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the connective tissue of the whole game; playing it in order and the arc holds.',
    'Bloodborne': 'Bloodborne arrives early on purpose, widening the mood before the heavier titles in this list ask for more. In context, Bloodborne is the accessible face of the idea, the handhold before the deeper cuts. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the connective tissue of the whole game; playing it in order and the arc holds.',
    'Demon Souls': 'Demon Souls arrives early on purpose, widening the mood before the heavier titles in this list ask for more. In context, Demon Souls is the accessible face of the idea, the handhold before the deeper cuts. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the connective tissue of the whole game; playing it in order and the arc holds.',
    'Sekiro': 'Sekiro is the pivot of the set — close enough to trust, far enough to justify its place. Sekiro does the quiet work — it bridges the obvious pick and the one that demands more of you. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the connective tissue of the whole game; playing it in order and the arc holds.',
    'Lies of P': 'Lies of P is the pivot of the set — close enough to trust, far enough to justify its place. Lies of P does the quiet work — it bridges the obvious pick and the one that demands more of you. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the connective tissue of the whole game; playing it in order and the arc holds.',
    'Nioh': 'Nioh is the pivot of the set — close enough to trust, far enough to justify its place. Nioh does the quiet work — it bridges the obvious pick and the one that demands more of you. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the connective tissue of the whole game; playing it in order and the arc holds.',
    'Hollow Knight': 'Hollow Knight is where we land — the pick for when "the soulslike lineage: from despair to design" has been felt, not just described. Why it closes: Hollow Knight is the longest echo — the one that stays after the list ends. It asks for a little patience over instant payoff — enough to filter out the highlights-reel crowd, not enough to shut anyone out. Beside its neighbors it reads as the quiet afterimage of the whole game; playing it in order and the arc holds.',
  }},
  {
