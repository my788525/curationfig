...
export const MUSIC_THEMES: CurationTheme[] = [
  ...
  editorialNotes: {
    'Music for Airports': 'Eno\'s 1978 ambient manifesto loops gently enough to disappear — designed as furniture for attention, not listening. It opens the list because it defines the mode the rest relax into.',
    'Selected Ambient Works 85-92': 'Booth\'s cassette-era melodies are ambient with a pulse; warmth over abstraction. The accessible face because the tunes arrive even when you\'re only half-hearing.',
    'Dreamland': 'The Stone Roses\' orbit; baggy beats that hover rather than hit. It widens the mood from pure ambient into something you can almost dance to at 2am.',
    'Innervisions': 'Wonder\'s synth-led soul is too rich to be background, yet smooth enough to focus through. The pivot — the list\'s most melodic, most human hinge.',
    'Teardrop': 'Massive Attack\'s crystalline vocal over a heartbeat bass; trip-hop as lullaby. The bridge between ambience and song, the track most people mean by \'late-night\'.',
    'Weightless': 'Marconi Union engineered it with sound therapists for slow breathing; the list\'s most deliberate calm. It belongs because it\'s practically a tool, not just a track.',
    'Ambient 1': 'Eno\'s debut ambient album trades melody for tone and space; it is the concept every other pick here quietly borrows. It closes the set as the source, not just a song.',
    'Blonde': 'Ocean\'s ambient-R&B smudge is the list\'s outlier — vocals smeared into texture. It lands last because it\'s where focus music becomes feeling, the longest echo.',
  }},
  {
  ...
  editorialNotes: {
    'The Bends': 'Radiohead\'s 1995 sophomore record is where the melancholy turns cathedral-sized; \'Fake Plastic Trees\' sets the template. It opens the list because it\'s the clearest yes in the lineage.',
    'His and Hers': 'Theaudience\'s 1994 debut is the kitchen-sink romance end of the scene — small rooms, bigger feelings. The accessible face because the tunes are immediate even at their saddest.',
    'The Queen Is Dead': 'The Smiths\' 1986 high-water mark is the genealogical root; Morrissey\'s wit over Marr\'s jangle. It widens the mood back to the decade that made this possible.',
    'Loveless': 'My Bloody Valentine\'s 1991 wall of guitar is the shoegaze absolute — melody buried in noise you feel more than hear. The pivot because it\'s the scene at its most beautiful and most opaque.',
    'Parklife': 'Blur\'s 1994 panorama of ordinary England is the list\'s most extroverted sadness — comedy as a shield. The bridge between introspection and observation.',
    'Crooked Rain': 'Pavement\'s 1994 slacker classic is the transatlantic cousin; deadpan Americana that admires this scene from afar. It argues the mood crossed the Atlantic and kept its irony.',
    'Girls & Boys': 'Blur\'s 1994 single is the scene\'s dancefloor turn — a rare moment of the melancholy actually moving. The hinge because it proves the sadness could be a hit.',
    'Ride Nowhere': 'Ride\'s 1990 debut is shoegaze\'s opening statement; torrents of guitar over a whisper. It closes the set as the loud, loving origin the quieter bands grew out of.',
  }},
  {
    slug: 'cosmic-jazz',
    channel: 'music',
  ...
  editorialNotes: {
    'A Love Supreme': 'Coltrane\'s 1965 four-part devotion is spiritual jazz\'s cornerstone — one chord as a prayer repeated until it opens. It opens the list because it names the ambition the rest chase.',
    'Kind of Blue': 'Davis\'s 1959 modal milestone trades chords for space; \'So What\' is the calmest door into the cosmic. The accessible face because its restraint is instantly legible.',
    'Head Hunters': 'Hancock\'s 1973 fusion plants jazz in a funk groove; the future arrives mechanized but warm. It widens the mood from the spiritual toward the orbital and danceable.',
    'Bitches Brew': 'Davis\'s 1970 double album is the big bang of fusion — edited chaos that sounds like takeoff. The pivot because it\'s where the music leaves the club for good.',
    'The QE2': 'Kenny Wheeler\'s 1976 large-ensemble record floats melody over open sky; the British answer to the American spirituals. The bridge between composition and the void.',
    'On the Corner': 'Davis\'s 1972 street funk is the genre\'s most misunderstood record — repetition as propulsion, the city as cosmos. It belongs because it argues the spiritual could be gritty.',
    'In a Silent Way': 'Davis\'s 1969 session is the quiet before Bitches Brew\'s storm; ambient jazz before the term existed. The hinge between acoustic space and electric horizon.',
    'Blue Train': 'Coltrane\'s 1957 hard-bop date is the launchpad — blues logic with a restlessness already reaching past the earth. It closes the set as the ground the flight left from.',
  }},
  {
  ...
  editorialNotes: {
    'good kid, m.A.A.d city': 'Kendrick Lamar\'s 2012 concept album maps a Compton day with cinematic precision; every skit a frame. It opens the list because it\'s the clearest proof the bar can be a sentence and a scene.',
    'To Pimp a Butterfly': 'Kendrick Lamar\'s 2015 jazz-rap opus is the most ambitious world-building here — grief, fame, and Black history in one room. The accessible face because its hooks still hit.',
    'Illmatic': 'Nas\'s 1994 debut is the narrative-standard bearer; \'N.Y. State of Mind\' is a short story in four minutes. The pivot because every later writer on this list is answering it.',
    'Ready to Die': 'Biggie\'s 1994 arc moves from boredom to mortality with novelistic control. The bridge between street memoir and the larger American story the genre kept telling.',
    'The College Dropout': 'West\'s 2004 debut trades hard-edge for insecurity and skits; the everyman narrator as author. It widens the mood from the street to the suburb and the soul.',
    'Food & Liquor': 'Lupe Fiasco\'s 2006 debut is bookish and cinematic; comic-book allusion as narrative device. It belongs because it argues the storytelling could be literary without losing swing.',
    'Section.80': 'Kendrick Lamar\'s 2011 indie debut is the sketchbook before the masterpiece; addiction and race as connected verses. The hinge that shows the world-builder mid-form.',
    'Damn': 'Kendrick Lamar\'s 2017 track-by-track confession is the tightest narrative here — faith and self as a closed loop. It closes the set as the genre at its most controlled and conflicted.',
  }},
  {
  ...
  editorialNotes: {
    'Clair de Lune': 'Debussy\'s 1905 piano miniature is the room itself — light through cloud, not the conservatory. It opens the list because it names the weather the rest of the set sits in.',
    'Gymnopedie': 'Satie\'s 1888 elegies are barely there; restraint as a form of weather. The accessible face because three minutes of them dissolves any demand on your attention.',
    'Moonlight Sonata': 'Beethoven\'s 1801 Adagio is the genre\'s most famous rainy window — grief held under a slow arpeggio. The pivot because it proves the mood could be Romantic without grandeur.',
    'Nocturnes Op.9': 'Chopin\'s 1830 night-pieces are intimacy as architecture; the left hand a heartbeat, the right a thought. The bridge between salon and solitude.',
    'The Four Seasons': 'Vivaldi\'s 1725 concertos are the season, not the canon — \'Winter\' especially is rain on glass. It belongs because it\'s the oldest proof weather was always the point.',
    'Prelude in C': 'Bach\'s 1722 Well-Tempered Clavier opener is a single breath expanded; the genre\'s quietest door. The hinge between order and the window\'s grey light.',
    'Spiegel im Spiegel': 'Pärt\'s 1978 tintinnabuli study is stasis as melody; a mirror facing a mirror. It widens the mood toward the hypnotic, the list\'s most weatherless calm.',
    'Recomposed': 'Richter\'s 2012 rewrite of Vivaldi\'s Seasons is the modern room — cello cycles under rain-glass electronics. It closes the set as the tradition hearing the weather again.',
  }},
  {
  ...
  editorialNotes: {
    'Model 500': 'Atkins\'s 1985 \'No UFOs\' is the founding transmission — machinery as hope, bass as prophecy. It opens the list because it is quite literally where the future started.',
    'Inner City': 'Saunderson\'s 1988 \'Big Fun\' proves the basement sound could fill a dancefloor without losing its clockwork soul. The accessible face because the joy is immediate.',
    'Strings of Life': 'Saunderson\'s 1987 anthem is the genre\'s most emotional machine — strings over a beat that refuses to stop. The pivot because it argues techno could cry.',
    'Techno Music': 'Atkins\'s 1985 manifesto names the thing; a track that is its own definition. It widens the mood from song toward pure intent.',
    'Beyond the Dance': 'May\'s 1989 record is the romantic end of the trio — strings and chords that dream past the 4/4. The bridge between the basement and the festival it became.',
    'Nude Photo': 'Atkins\'s 1985 track is the blueprint stripped bare — drum, bass, and space. It belongs because it shows the future was always this minimal.',
    'Big Fun': 'Saunderson\'s 1988 hook is the scene\'s pop threshold; the moment the basement opened a window. The hinge between the three friends and the world that followed.',
    'Cybotron': 'Atkins and Davis\'s 1983 \'Clear\' is the proto-techno spark — sci-fi funk before the name existed. It closes the set as the source the other seven only extended.',
  }},
  {
